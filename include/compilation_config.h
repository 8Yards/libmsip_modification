...
/* Debug autocalling */
/* #undef DEBUG_UDPPACKETDROPEMUL */

/* Define to 1 if you have the <dlfcn.h> header file. */
#define HAVE_DLFCN_H 1

/* Define to 1 if you have libmcrypto with DTLS support */
#define HAVE_DTLS 1
...
/* Define to 1 if you have libmnetutil with SCTP support */
/* #undef HAVE_SCTP */
...
/* Name of package */
#define PACKAGE "libmsip"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "Erik Eliasson <ere@kth.se>"

/* Define to the full name of this package. */
#define PACKAGE_NAME "libmsip"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING PACKAGE_STRING_FULL

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "libmsip"
